...
import 'package:INTAKHIB/flutter_frontend/dmrtd_lib/src/extension/string_apis.dart';
...
class EfDG11 extends DataGroup {
  ...
  static const FULL_NAME_TAG = 0x5F1F;
  ...
  static const PERMANENT_ADDRESS_TAG = 0x5F13;

  static const TELEPHONE_TAG = 0x5F14;
  static const PROFESSION_TAG = 0x5F1B;
  static const TITLE_TAG = 0x5F14;

  static const PERSONAL_SUMMARY_TAG = 0x5F15;

  static const PROOF_OF_CITIZENSHIP_TAG = 0x5F16;
  static const OTHER_VALID_TD_NUMBERS_TAG = 0x5F19;
      ...
      try {
        ...
        switch (uvtv.tag.value) {
          ...
          case CUSTODY_INFORMATION_TAG:
            ...
            break;
        //default:
        // Ignorer les tags inconnus pour éviter les erreurs d'offset
        //break;
        }
      } catch (e) {
        // Ignorer les erreurs pour éviter les interruptions du traitement
        print('Error parsing tag at offset $tagListBytesRead: $e');
        tagListBytesRead++;
      }
    }
  }
